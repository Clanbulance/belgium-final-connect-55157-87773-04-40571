...
export const Pricing = () => {
  ...
  const pricingTiers = [{
    ...
    features: [t("pricing.tier1.f1"), t("pricing.tier1.f2"), t("pricing.tier1.f3"), t("pricing.tier1.f4"), t("pricing.tier1.f5")],
    cta: t("pricing.cta"),
    popular: false
  }, {
    ...
    features: [t("pricing.tier2.f1"), t("pricing.tier2.f2"), t("pricing.tier2.f3"), t("pricing.tier2.f4"), t("pricing.tier2.f5")],
    cta: t("pricing.cta"),
    popular: true
  }, {
    ...
    features: [t("pricing.tier3.f1"), t("pricing.tier3.f2"), t("pricing.tier3.f3"), t("pricing.tier3.f4"), t("pricing.tier3.f5"), t("pricing.tier3.f6")],
    cta: t("pricing.cta"),
    popular: false
  }];
  return <section id="pricing" className="py-24" style={{
    backgroundColor: "var(--background)"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-md-2 grid-lg-3 gap-8 max-w-6xl mx-auto">
          {pricingTiers.map(tier => <Card key={tier.name} className={`pricing-card relative ${tier.popular ? "pricing-card-popular" : ""}`}>
              {tier.popular && <div className="pricing-badge-container">
              ...
              <CardContent>
                <ul className="space-y-3 mb-8">
                  {tier.features.map(feature => <li key={feature} className="pricing-feature">
                      <Check style={{
                  width: "1.25rem",
                  height: "1.25rem",
                  flexShrink: 0,
                ...
                <Button variant={tier.popular ? "hero" : "outline"} className="w-full" size="lg" onClick={() => handlePricingClick(tier.name)}>
                  {tier.cta}
                </Button>
              </CardContent>
            </Card>)}
