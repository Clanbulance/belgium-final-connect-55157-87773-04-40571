export const partnership = {
  ...
  'partnership.subtitle': 'As the official Belgian counterpart to Otterino, we bring engineering excellence to Belgian businesses. We offer the exact same premium services with local expertise and multilingual support tailored for the Belgian market.',
